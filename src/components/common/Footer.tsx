            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-400 leading-relaxed">
              <div>
                <p className="mb-3">
                  ...
                  This website provides information about our estate planning
                  services. Prior results do not guarantee a similar outcome.
                  The choice of an estate planner is an important decision and
                ...
                <p className="mb-3">
                  ...
                  Contacting us does not create a professional service
                  relationship.
                </p>
              </div>
              <div>
                <p className="mb-3">
                  ...
                  Our specialists are certified estate planners serving the
                  Southern California region. We work with qualified
                  professionals for specialized matters outside our service
                  areas.
                </p>
                <p>
                  <strong className="text-neutral-300">
                  ...
                  Any tax advice contained in this website was not intended or
                  written to be used for the purpose of avoiding penalties
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
              <p className="text-neutral-400 text-sm">
                © {currentYear} Generation Catalyst Estate Planning. All rights
                reserved.
              </p>
