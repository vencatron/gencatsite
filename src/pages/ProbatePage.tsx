    ...
    >
      <div className="mx-auto max-w-4xl">
        <header className="mb-8 text-center">
          ...
          <p className="mt-3 text-neutral-700">Compassionate guidance through the probate process and estate administration.</p>
        </header>
        ...
        >
          ...
          <div className="relative">
            ...
            <ul className="mt-4 grid gap-2 text-neutral-700 sm:grid-cols-2">
              ...
              <li>Creditor notifications and claims</li>
              <li>Asset distribution</li>
            </ul>
            <p className="mt-6 text-neutral-700">We guide families through the probate process with care and efficiency, handling all legal requirements while minimizing stress during a difficult time.</p>
          </div>
        </motion.div>
      </div>
    </motion.div>
